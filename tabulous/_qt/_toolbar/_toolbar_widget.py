...
class QTableStackToolBar(QtW.QToolBar, QHasToolTip):
    ...
    def registerAction(self, tabname: str, f: Callable, icon: Union[str, Path]):
        ...
        toolbar.appendAction(lambda: f(self.viewer), qicon)
        return
    ...
    def initToolbar(self):
        ...
        self.registerAction("File", cmd.io.open_table, ICON_DIR / "open_table.svg")
        self.registerAction("File", cmd.io.open_spreadsheet, ICON_DIR / "open_spreadsheet.svg")
        self.registerAction("File", cmd.io.save_table, ICON_DIR / "save_table.svg")
        self.addSeparatorToChild("File")
        self.registerAction("File", cmd.io.open_sample, ICON_DIR / "open_sample.svg")

        self.registerAction("Table", cmd.table.copy_as_table, ICON_DIR / "copy_as_table.svg")
        self.registerAction("Table", cmd.table.copy_as_spreadsheet, ICON_DIR / "copy_as_spreadsheet.svg")
        self.addSeparatorToChild("Table")
        self.registerAction("Table", cmd.table.groupby, ICON_DIR / "groupby.svg")
        self.registerAction("Table", cmd.table.switch_header, ICON_DIR / "switch_header.svg")
        self.registerAction("Table", cmd.table.concat, ICON_DIR / "concat.svg")
        self.registerAction("Table", cmd.table.pivot, ICON_DIR / "pivot.svg")
        self.registerAction("Table", cmd.table.melt, ICON_DIR / "melt.svg")
        self.addSeparatorToChild("Table")
        self.registerAction("Table", cmd.table.show_finder_widget, ICON_DIR / "find_item.svg")
        self.registerAction("Table", cmd.table.sort_table, ICON_DIR / "sort_table.svg")
        self.addSeparatorToChild("Table")
        self.registerAction("Table", cmd.table.random, ICON_DIR / "random.svg")

        self.registerAction("Analyze", cmd.analysis.summarize_table, ICON_DIR / "summarize_table.svg")
        ...
        self.registerAction("View", cmd.view.set_popup_mode, ICON_DIR / "view_popup.svg")
        self.registerAction("View", cmd.view.set_dual_h_mode, ICON_DIR / "view_dual_h.svg")
        self.registerAction("View", cmd.view.set_dual_v_mode, ICON_DIR / "view_dual_v.svg")
        self.registerAction("View", cmd.view.reset_view_mode, ICON_DIR / "view_reset.svg")
        self.addSeparatorToChild("View")
        self.registerAction("View", cmd.view.tile_tables, ICON_DIR / "tile.svg")
        self.registerAction("View", cmd.view.untile_table, ICON_DIR / "untile.svg")

        self.registerAction("Plot", cmd.plot.plot, ICON_DIR / "plot.svg")
        self.registerAction("Plot", cmd.plot.scatter, ICON_DIR / "scatter.svg")
        self.registerAction("Plot", cmd.plot.errorbar, ICON_DIR / "errorbar.svg")
        self.registerAction("Plot", cmd.plot.hist, ICON_DIR / "hist.svg")
        self.addSeparatorToChild("Plot")
        self.registerAction("Plot", cmd.plot.swarmplot, ICON_DIR / "swarmplot.svg")
        self.registerAction("Plot", cmd.plot.barplot, ICON_DIR / "barplot.svg")
        self.registerAction("Plot", cmd.plot.boxplot, ICON_DIR / "boxplot.svg")
        self.registerAction("Plot", cmd.plot.boxenplot, ICON_DIR / "boxenplot.svg")
        self.addSeparatorToChild("Plot")
        self.registerAction("Plot", cmd.plot.new_figure, ICON_DIR / "new_figure.svg")
