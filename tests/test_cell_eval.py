...
def test_set_ndarray(make_tabulous_viewer):
...
def test_column_vector_output(make_tabulous_viewer):
    viewer: TableViewer = make_tabulous_viewer()
...
def test_partial_column_vector_output(make_tabulous_viewer):
    viewer: TableViewer = make_tabulous_viewer()
...
def test_row_vector_output(make_tabulous_viewer):
    viewer: TableViewer = make_tabulous_viewer()
...
def test_partial_row_vector_output(make_tabulous_viewer):
    viewer: TableViewer = make_tabulous_viewer()
...
def test_scalar_output(make_tabulous_viewer):
    viewer: TableViewer = make_tabulous_viewer()
    sheet = viewer.add_spreadsheet({"a": [1, 3, 5]})
    qtable = sheet.native._qtable_view
...
def test_updating_namespace(make_tabulous_viewer):
    import numpy as np
    viewer: TableViewer = make_tabulous_viewer()
    sheet = viewer.add_spreadsheet({"a": [1, 3, 5]})
    qtable = sheet.native._qtable_view
...
def test_updating_namespace_by_decorator(make_tabulous_viewer):
    import numpy as np
    viewer: TableViewer = make_tabulous_viewer()
    sheet = viewer.add_spreadsheet({"a": [1, 3, 5]})
    qtable = sheet.native._qtable_view
